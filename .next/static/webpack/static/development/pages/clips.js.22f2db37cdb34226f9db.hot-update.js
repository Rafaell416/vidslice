...
function (_Component) {
  ...
  function cls() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onClickClipCard", function (id) {
      var activeClipIndex = _this.props.state.vidslice.activeClipIndex;
      Object(_redux_actions__WEBPACK_IMPORTED_MODULE_9__["toggleSelectClipCard"])(id, activeClipIndex);
      console.log(id);
    });
...
//# sourceMappingURL=clips.js.22f2db37cdb34226f9db.hot-update.js.map