...
function (_Component) {
  ...
  function cls() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleStartEditingProcess", function (e, clip) {
      ...
      console.log(startAtInSeconds, endAtInSeconds); // this.setState({
      //   isEditing: true,
      //   rangeValueWhenEditing: {
      //     min: startAt,
      //     max: endAt
...
//# sourceMappingURL=clips.js.1bd3b9416562e547c090.hot-update.js.map