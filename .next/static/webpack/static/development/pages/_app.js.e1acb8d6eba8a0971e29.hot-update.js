...
var vidslice = function vidslice() {
  ...
  switch (action.type) {
    ...
    case 'TOGGLE_SELECTED_CLIP_CARD':
      return _objectSpread({}, state, {
        clips: state.activeClipIndex === 0 ? _objectSpread({}, state.clips[action.activeClipIndex], {
          selected: false
        }) : state.activeClipIndex
      });
      break;
...
//# sourceMappingURL=_app.js.e1acb8d6eba8a0971e29.hot-update.js.map