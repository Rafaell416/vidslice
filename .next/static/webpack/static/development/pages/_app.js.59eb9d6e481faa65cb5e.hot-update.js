...
var vidslice = function vidslice() {
  ...
  switch (action.type) {
    ...
    case 'TOGGLE_SELECTED_CLIP_CARD':
      return _objectSpread({}, state, {
        clips: state.activeClipIndex ? _objectSpread({}, state.clips[action.activeClipIndex], {
          selected: false
        }) : state.clips.map(function (clip) {
          return clip.id === action.id ? _objectSpread({}, clip, {
            selected: true
          }) : clip;
        })
      });
...
//# sourceMappingURL=_app.js.59eb9d6e481faa65cb5e.hot-update.js.map