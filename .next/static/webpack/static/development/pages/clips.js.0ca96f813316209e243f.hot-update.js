  ...
  function cls() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleStartEditingProcess", function (e, clip) {
      ...
      var id = clip.id,
          ...
          endAt = clip.endAt,
          name = clip.name;
      console.log(clip); // this.setState({
      //   isEditing: true,
      //   rangeValueWhenEditing: {
      //     min: startAt,
      //     max: endAt
...
//# sourceMappingURL=clips.js.0ca96f813316209e243f.hot-update.js.map